...
export const testimonialData: Testimonial[] = [
  {
    ...
    image: image1,
    content:
      "I can't say enough good things about BigData Ghana's data analytics training. The sessions were very engaging, and I loved that they were done online. Philip made the concepts easy to understand, and the hands-on approach helped me to solidify my understanding of the concepts. I would recommend this training to anyone who wants to get ahead in data analytic",
  },
  {
    id: 2,
    name: "Baaba",
