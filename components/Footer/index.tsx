...
const Footer = () => {
  return (
    <>
      <footer className="border-t border-stroke bg-btndark dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-10 mt-5 text-justify text-gray-400">
                  Royal Kingdom Estate is committed to delivering a high level
                  of expertise, customer service, and attention to detail to the
                  real estate market across Ghana and beyond. Let us facilitate
                  your vision of owning land or building a home on the African
                  continent.
                </p>
              </motion.div>
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  <h4 className="mb-9 text-itemtitle2 font-medium text-orange-500 dark:text-white">
                    Quick Links
                  </h4>
                  ...
                  <ul>
                    <li>
                      <a
                        href="/"
                        className="mb-3 inline-block text-gray-400 hover:text-orange-500"
                      >
                        Home
                      </a>
                    </li>
                ...
                >
                  ...
                  <p className="mb-4 w-full text-gray-400 md:w-[90%]">
                    ...
                    N0. 2 Asafoatse Kukudabi Street, <br /> Tse Addo, Accra
                    Ghana. <br />
                    <br />
                    +233 55 755 5909 <br />
                    +233 54 385 6099 <br /> +233 27 277 8880
                  </p>
                </motion.div>
              </div>
            </div>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            <motion.div
              ...
              transition={{ duration: 1, delay: 0.1 }}
              viewport={{ once: true }}
              className="animate_top text-center lg:text-left" // Added text-center for mobile
            >
            ...
            >
              <p>
                &copy; Royal Kingdom Estate. All rights reserved. Powered By{" "}
                <a
                  href="www.apitechnologiesgh.com"
                  target="_blank"
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  ...
                  >
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-orange-500"
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                      fill="none"
