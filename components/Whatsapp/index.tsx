      ...
      {isOpen ? (
        <div className="w-80 overflow-hidden rounded-lg bg-white shadow-xl">
          ...
          <div className="p-4">
            ...
            <button
              onClick={sendMessage}
              className="flex w-full items-center justify-center gap-2 rounded bg-green-500 py-2 text-white hover:bg-green-600"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-5 w-5"
        ...
        <button
          ...
          className="flex h-10 w-10 items-center justify-center bg-green-500 shadow-lg transition-all hover:bg-green-600"
